...
- ⚡ Held a 3D-capable document viewer to a **292 KB gzip** main bundle by deferring the three.js engine into a 458 KB on-demand worker chunk
- 🔐 Designed subscription-aware feature gating (HOC pattern + role-based context + Axios interceptor enforcement) across **27 routes**
- 🌐 Shipped a bilingual EN/FR platform with **500+ type-safe translation keys** via react-i18next
